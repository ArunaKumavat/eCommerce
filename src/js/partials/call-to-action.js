enquire.register("screen and (min-width:61.063em)", {
    ...
    match : function() {
        if($('.call-to-action-flexslider').length) {
            var flex = $('.call-to-action-flexslider').data('flexslider').destroy(); //detach
            $('.call-to-action-container').append(flex); //reattach
        }
    },
    ...
    unmatch : function() {
        $('.call-to-action-flexslider').flexslider({
            animation: "slide",
            controlNav: false,
            start: function() {
                $('.call-to-action-flexslider').data('flexslider').resize();
            },
